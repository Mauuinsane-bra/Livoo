...
// Kiwi.com — deeplink com origem/destino/data pré-preenchidos
// PT + BRL + tracking de comissão ativo via affilid
...
function buildFlightLink(origin?: string, dest?: string, date?: string): string {
  if (!origin || !dest) return KIWI_FALLBACK
