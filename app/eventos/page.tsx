...
const events: Event[] = [
  ...
  // ── CULTURA ──
  {
    ...
    description: 'O maior espetáculo da Terra. Desfiles das escolas de samba no Sambódromo da Marquês de Sapucaí — uma experiência única no mundo.',
    date: 'Mar 2026',
    location: 'Rio de Janeiro, Brasil',
    country: 'Brasil',
    flag: '🇧🇷',
    ...
    >
      ...
      <div style={{ padding: '0 20px 20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          {/* Botão montar pacote */}
          <Link
            href={`/roteiro?evento=${encodeURIComponent(event.title)}&destino=${encodeURIComponent(event.location)}`}
            style={{
              display: 'block',
