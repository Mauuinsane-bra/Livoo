...
// Experiências em destaque — eventos futuros selecionados manualmente
// Atualize conforme as datas passarem ou novos eventos forem adicionados
const experiences = [
  {
    id: 'f1-monaco',
  ...
  },
  {
    ...
    description: 'O maior festival de música do mundo no Rio de Janeiro. Uma semana de shows com os maiores artistas do planeta.',
    date: 'Set 2026',
  ...
  {
    id: 'rally-georgia',
    title: 'Rally WRC — Geórgia',
    description: 'Velocidade, lama e paisagens deslumbrantes no coração do Cáucaso. O destino mais exclusivo do calendário automobilístico.',
    date: 'Out 2026',
    location: 'Tbilisi, Geórgia',
    price: 'Acesso gratuito em muitos trechos especiais',
    category: 'Automobilismo',
  ...
  },
  {
    ...
    date: 'Fev 2027',
    location: 'Rio de Janeiro, Brasil',
    price: 'Arquibancada a partir de R$ 80',
    category: 'Cultura',
    imageUrl: 'https://images.unsplash.com/photo-1518791841217-8f162f1912da?w=600',
    tag: 'Ícone',
