...
function RegionRow({
  ...
  const link = minFlight
    ? minFlight.link
    : `https://br.trip.com/flights/?locale=pt-BR&curr=BRL`
      ...
      <section style={{ padding: '40px 0 80px' }}>
        <div className="container" style={{ maxWidth: 900 }}>
          ...
          <p style={{
            ...
            Preços encontrados nas últimas 48h via Travelpayouts · podem variar conforme disponibilidade · via Trip.com
          </p>
