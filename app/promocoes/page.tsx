      ...
      >
        ...
        <div style={{ padding: '14px 16px' }}>
          ...
          <div style={{
            ...
            {deal.isRoundTrip ? 'Ida + volta' : 'Só ida'} · {deal.stops === 0 ? 'voo direto' : `${deal.stops} escala`} · via Kiwi.com
          </div>
        </div>
      </div>
    </a>
        ...
        <div className="container">
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 28 }}>
            <div>
              ...
              <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.82rem', color: '#64748B', margin: 0 }}>
                Preços estimados de ida — clique para ver datas disponíveis no Kiwi.com
              </p>
            </div>
            <span style={{
              fontFamily: 'Inter, sans-serif', fontSize: '0.72rem',
          ...
          {loading ? (
            ...
            <div style={{
              ...
              <a
                href={`https://kiwi.tpk.lu/oHyzWHop`}
                target="_blank"
                rel="noopener noreferrer"
