    ...
    >
      ...
      <div style={{ padding: '14px 16px 16px', display: 'flex', flexDirection: 'column', gap: 10, flex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
          <div>
            <div style={{
              fontFamily: 'Inter, sans-serif', fontSize: 9, color: '#9aaabb',
  ...
  return (
    <div style={{ background: '#fff', borderRadius: 16, overflow: 'hidden', border: '1px solid #E2E8F0' }}>
      ...
      <div style={{ padding: '14px 16px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
        <div style={{ height: 10, background: '#fafaf7', borderRadius: 6, width: '50%' }} />
        <div style={{ height: 28, background: '#fafaf7', borderRadius: 6, width: '55%' }} />
        <div style={{ height: 40, background: '#fafaf7', borderRadius: 10 }} />
      </div>
    </div>
  )
}
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{
            ...
            Preços reais em Reais (R$) — comparamos centenas de opções para você. Clique num destino e compre direto no Kiwi.com em Português.
          </p>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '36px 24px 72px' }}>
        ...
        <div style={{
          ...
          {updatedAt && !loading && (
            <div style={{
              ...
              fontFamily: 'Inter, sans-serif', fontSize: 12, color: '#9aaabb',
            }}>
        ...
        {!loading && !error && flights.length > 0 && (
          <p style={{
            ...
            Você é redirecionado para o Kiwi.com em Português com preços em Reais · sem custo adicional para você.
          </p>
        )}
      </div>
